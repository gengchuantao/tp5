...
$(function(){
    ...
    $("#companyPPM").bootstrapTable('destroy').bootstrapTable({
        ...
        url : "/../tp5/public/index.php/index/performance/jsonDataCompanyPPM", // 服务器数据的加载地址
    ...
    $("#performanceIndex").bootstrapTable('destroy').bootstrapTable({
        method : 'post', // 服务器数据的请求方式 get or post
        url : "/../tp5/public/index.php/index/performance/jsonDataCompanyPPM", // 服务器数据的加载地址
        ...
        columns: [{
            ...
            field: 'key_project_index',
            title: '重点项目指标',
            align: 'right',
        },{
            field: 'key_project_complete',
            title: '重点项目完成',
            align: 'right',
        },{
            field: 'key_project_rate',
            title: '完成率',
            align: 'right',
            formatter: function (value) {
                value = value*100;
    ...
    $('#performanceIndex').bootstrapTable('refresh');
})
