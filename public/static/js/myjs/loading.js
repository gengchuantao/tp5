...
let _LoadingHtml = '' +
    ...
    '<div style="position: absolute; cursor1: wait; left: ' + _LoadingLeft + 'px; top:' + _LoadingTop + 'px; width: auto; height: 57px; line-height: 57px; padding-left: 50px; padding-right: 5px; background: #f3f8ff url(/../tp5/public/static/img/loading.gif) no-repeat scroll 5px 10px; border: 2px solid #f3f8ff; color: #696969; font-family:\'Microsoft YaHei\';">页面加载中，请稍后...</div></div>';
//呈现loading效果
