...
class ArrearsController extends IndexController
{
    public function index(){
        ...
        $arrears_staff = Request::instance()->get('arrears_staff');
        ...
        Session::set('arrears_staff',$arrears_staff);
        ...
        $arrearss = $Arrears
            ...
            ->where('arrears_staff', 'like', '%' . $arrears_staff . '%')
    ...
    function export(){
        ...
        $arrears_staff = Session::get('arrears_staff');
        $excel = new expExcel();
        $xlsName  = "欠款明细表";
